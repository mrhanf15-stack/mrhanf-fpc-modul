...
- **NEU**: "Cache neu aufbauen" Button im Admin-Modul
  ...
  - Sicherheitschecks: Doppelstart-Schutz, Preloader-Existenz, Prozess-Validierung
- **NEU**: Sprachkonstanten fuer Buttons und Meldungen in allen 4 Sprachen (DE/EN/FR/ES)
- **VERBESSERT**: Cache-Status-Tabelle mit Rebuild-Status-Zeile
- **VERBESSERT**: Flush-Funktion behaelt jetzt auch `rebuild.pid` und `rebuild_manual.log`
